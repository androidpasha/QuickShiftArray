...
public:
	class Iterator : public std::iterator<std::random_access_iterator_tag, T> {
			size_t size; T* endPtr; T* shiftPtr; //размер массива, указатели на конец массива и нулевую позицию, заданную пользователем в диапазоне массива
		public: 
	...
	T& operator ++ (int);							//постфиксный инкремент. Возвращает ячейку с номером circleIdx++.
	T& operator ++ ();								//префиксный инкремент. Возвращает ячейку с номером ++circleIdx.
	T& operator -- (int); 							//постфиксный декремент. Возвращает ячейку с номером circleIdx--.
	T& operator -- ();								//префиксный декремент. Возвращает ячейку с номером --circleIdx.
